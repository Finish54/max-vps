...
async def admin_menu(lang) -> ReplyKeyboardMarkup:
    ...
    kb.row(
        ...
        keyBtn(text=_('admin_metric_list_btn', lang)),
...
async def show_user_menu(lang) -> ReplyKeyboardMarkup:
    kb = ReplyKeyboardBuilder()
    kb.row(
        keyBtn(text=_('admin_statistic_show_all_users_btn', lang)),
        keyBtn(text=_('admin_statistic_ref_bord_btn', lang))
    )
    kb.row(
...
async def send_user_button(lang) -> ReplyKeyboardMarkup:
    kb = ReplyKeyboardBuilder()
    kb.add(types.KeyboardButton(
        text=_('input_user_chat_btn', lang),
